...
DEPLOYMENT INSTRUCTIONS
  ...
  4. Open a browser, then navigate to "http://localhost/pf".  If "index.php" has not been specified for DirectoryIndex, you'll need to use "http://localhost/pf/index.php" instead.
